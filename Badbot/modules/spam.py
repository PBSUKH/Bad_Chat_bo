...
from config import SK10, SUDO_USERS, CMD_HNDLR as hl
from AltronX.data import GROUP, PORMS


@SK10.on(events.NewMessage(incoming=True, pattern=r"\%sspam(?: |$)(.*)" % hl))
...
@SK10.on(events.NewMessage(incoming=True, pattern=r"\%spspam(?: |$)(.*)" % hl))
